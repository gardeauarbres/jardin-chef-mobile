-- =====================================================
-- JARDIN CHEF - SETUP COMPLET DE LA BASE DE DONNÉES
...
-- =====================================================
-- FIN DES MIGRATIONS - TOUT EST PRÊT !
-- =====================================================

-- Afficher un message de succès
DO $$
BEGIN
  RAISE NOTICE 'Setup terminé avec succès ! Tables créées : materials, material_movements, site_materials, company_profile';
END $$;
