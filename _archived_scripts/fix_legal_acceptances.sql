-- =====================================================
-- FIX: Ajouter la table legal_acceptances
-- =====================================================
-- Ce script crée la table pour stocker les acceptations
-- des documents légaux par les utilisateurs.
-- =====================================================

-- Supprimer la table si elle existe (développement uniquement)
-- ATTENTION: Décommentez cette ligne SEULEMENT en développement
-- DROP TABLE IF EXISTS public.legal_acceptances CASCADE;

-- Créer la table legal_acceptances
...
BEGIN
  ...
  RAISE NOTICE '📝 Les utilisateurs devront maintenant accepter les documents légaux lors de leur première connexion.';
END $$;
